...
public class SuperHeroesRepository {
  ...
  private void fillRepositoryWithFakeData() {
    superHeroes.add(new SuperHero("Scarlet Witch",
        ...
        "Scarlet Witch was born at the Wundagore base of the High Evolutionary, she and her twin brother Pietro were the children of Romani couple Django and Marya Maximoff. The High Evolutionary supposedly abducted the twins when they were babies and experimented on them, once he was disgusted with the results, he returned them to Wundagore, disguised as regular mutants."));
    superHeroes.add(
    ...
    superHeroes.add(new SuperHero("Winter Soldier",
        ...
        "Olympic-class athlete and exceptional acrobat highly skilled in both unarmed and armed hand-to-hand combat and extremely accurate marksman. he is fluent in four languages including German and Russian."));
